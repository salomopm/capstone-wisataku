...
class WelcomeActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val appName = ObjectAnimator.ofFloat(binding.tvAppName, View.ALPHA, 1f).setDuration(100)
        val appMotto = ObjectAnimator.ofFloat(binding.tvAppMotto, View.ALPHA, 1f).setDuration(100)
        val loginButton = ObjectAnimator.ofFloat(binding.loginBtn, View.ALPHA, 1f).setDuration(100)
        val registerButton =
        ...
        AnimatorSet().apply {
            playSequentially(appName, appMotto, together)
            start()
        }
    }
}